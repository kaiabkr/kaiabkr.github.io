...
let genres = ["curating creative ontent for brands", "being authentic", "", "brand marketing that speaks to you"];
...
function demonstrationFunction() {
    ...
    heading.style.textShadow = "0px 0px 40px #fff";
...
function generate(incUserInput) {
    ...
    outputParagraph.innerText = incUserInput + "? Awesome! If you want to learn more about " + genres[randomGenreIndex] + " navigate through the website to learn more";
}
